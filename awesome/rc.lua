...
-- RAM usage graph
mymemgraph = wibox.widget.graph()
mymemgraph:set_width(50)
mymemgraph:set_background_color('#494B4F')
mymemgraph:set_color('#AECF96')
mymemgraph.tooltip = awful.tooltip({ objects = { mymemgraph },})
vicious.cache(vicious.widgets.mem)
vicious.register(mymemgraph, vicious.widgets.mem,
                 function (widget, args)
                    mymemgraph.tooltip:set_text("RAM: " .. args[2] .. "MB / " .. args[3] .. "MB")
                    return args[1]
                 end, 1)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            mysepp,
            wibox.container.mirror(mycpugraph, {vertical = false, horizontal = true}),
            myseps,
            wibox.container.mirror(mymemgraph, {vertical = false, horizontal = true}),
            mysepp,
            mykeyboardlayout,
            mysepp,
            mytextclock,
...
awful.rules.rules = {
    ...
    -- Position rules
    --{ rule = { class = "chromium-browser-chromium.Chromium-browser-chromium" },
